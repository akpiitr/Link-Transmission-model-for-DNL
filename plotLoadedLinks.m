% function [handle_fig,handle_rect,handle_txt] = plotLoadedLinks(nodes,links,load,show_labels,fig_num,scale,maxLoad,cmap)
...
if isempty(fig_num)
    ...
    handle_fig=fig_num;
    set(fig_num, 'Position', [200,50,1000,900]);
%     handle_fig = figure('Position',[200,50,1000,900]);
    hold on;
end
